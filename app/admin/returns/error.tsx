...
export default function ReturnsError({
    ...
    useEffect(() => { console.error('Returns Error:', error); }, [error]);
    ...
    return (
        <div className="min-h-screen bg-background flex items-center justify-center p-6">
            <div className="max-w-md w-full text-center">
                ...
                <p className="text-text-secondary text-sm mb-8">We encountered an unexpected error while loading returns.</p>
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <Button variant="outline-luxury" onClick={() => window.location.href = '/admin/returns'}>Reload Page</Button>
                </div>
            </div>
        </div>
    );
