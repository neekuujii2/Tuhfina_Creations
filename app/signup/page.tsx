                    ...
                    <form onSubmit={handleSignup} className="space-y-4">
                        <div>
                            ...
                            <div className="relative">
                                <Mail className="absolute left-4 top-1/2 -translate-y-1/2 text-luxury-gray/50" size={18} />
                                <input
                                    id="email"
                                    type="email"
                                    required
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <Key className="absolute left-4 top-1/2 -translate-y-1/2 text-luxury-gray/50" size={18} />
                                <input
                                    id="password"
